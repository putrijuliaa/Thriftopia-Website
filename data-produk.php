...
<head>
    ...
    <title>Thriftopia - Admin Data Produk</title>
...
<header>
        ...
        <div class="container">
            ...
            <div class="box">
                <button class="btn btn-primary mb-2">
                    <a href="tambah-produk.php" style="color: white;">Tambah Produk</a>
                </button>
                <table border="1" cellspacing="0">
                    ...
                    <tbody>
                        ...
                        ?>
                        <tr data-product-id="<?php echo $row['product_id']; ?>" data-created-at="<?php echo strtotime($row['created_at']); ?>"></tr>
                            <td><?php echo $no++; ?></td>
                            ...
                            <td>
                                <button class="btn btn-secondary btn-sm me-1" onclick="window.location.href='edit-produk.php?id=<?php echo $row['product_id']; ?>'">
    ...
    <!-- End Script -->
     <!-- JavaScript to remove products after 1 minute -->
    <script>
