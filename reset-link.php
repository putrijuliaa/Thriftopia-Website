...
// Update status link menjadi belum diklik dan reset jumlah klik untuk produk yang sesuai
$update = mysqli_query($conn, "UPDATE tb_product SET link_clicked = 0, link_click_count = 0 WHERE product_id = $product_id");
